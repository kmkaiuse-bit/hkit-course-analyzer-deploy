...
const ResultsDisplay = {
    ...
    showResults(results, programmeId) {
        ...
        if (typeof StorageManager !== 'undefined') {
            ...
            // Show notification about data saving
            if (typeof NotificationManager !== 'undefined') {
                NotificationManager.info('💾 Saving analysis results to learning database...', 2000);
            }
            ...
            StorageManager.recordAnalysisResults(results, studentInfo)
                .then(() => {
                    if (typeof NotificationManager !== 'undefined') {
                        ...
                        NotificationManager.success(
                            `✅ Saved ${results.length} course mappings (${exemptionCount} exemptions) to learning database`,
                            3000
                        );
                    }
                })
                .catch(error => {
                    ...
                    if (typeof NotificationManager !== 'undefined') {
                        NotificationManager.error('❌ Failed to save analysis results to database');
                    }
                });
        }
